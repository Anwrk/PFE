...
from .models import Register, generate_unique_user_id, Event, Form, Question, Response, Answer, CourseMaterial
...
def materials_view(request):
    ...
    return render(request, 'main/Course.html', {'materials': materials})